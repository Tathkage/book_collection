class UserBooksController < ApplicationController
  ...
  def index
    @user_books = UserBook.joins(:user, :book).where.not(users: { id: nil }, books: { id: nil })
  end
  ...
  # GET /user_books/new
  def new
    @user_book = UserBook.new # Create a new user_book instance
    @book = Book.new # Create a new book instance
  end
